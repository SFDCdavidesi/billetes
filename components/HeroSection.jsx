...
const heroImages = {
  main: '/images/billetes/afghanistan-1-rupee-sh-1298-1299-1919-1920--p1_1.jpg',
  secondary: '/images/billetes/afghanistan-10-afghanis-nd-1926-1928--p8_1.jpg',
  tertiary: '/images/billetes/afghanistan-1-caboulies-rupee-nd-1928--p14_1.jpg',
};
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link href="/signup" className="btn-secondary inline-flex items-center justify-center gap-2">
                <span>{t('hero.createAccount')}</span>
              </Link>
            </div>
            ...
            <div className="mt-12 grid grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-sm text-gray-500">{t('hero.statCollectors')}</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold text-gray-900">120K+</p>
                <p className="text-sm text-gray-500">{t('hero.statBanknotes')}</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold text-gray-900">85+</p>
                <p className="text-sm text-gray-500">{t('hero.statCountries')}</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 z-20 bg-white rounded-xl shadow-xl p-3 transform -rotate-6 hover:rotate-0 transition-transform duration-500">
                <Image
                  src={heroImages.secondary}
                  alt="Billete histórico alemán"
                  width={200}
                  height={120}
              ...
              <div className="absolute -top-4 -right-4 z-20 bg-white rounded-xl shadow-xl p-3 transform rotate-6 hover:rotate-0 transition-transform duration-500">
                <Image
